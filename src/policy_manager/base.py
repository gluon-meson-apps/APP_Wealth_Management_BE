...
class PolicyManager:
    def get_action(self, intent: IntentWithEntity, conversation: ConversationContext) -> Action:
        pass
...
class BasePolicyManager(PolicyManager):
    ...
    def get_action(self, intent: IntentWithEntity, conversation: ConversationContext) -> Action:
        for policy in self.policies:
            ...
            if handled:
                return action
        return ChitChatAction("qwen", ChatModel(), conversation.current_enriched_user_input)
