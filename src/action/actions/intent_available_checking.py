...
class IntentAvailableCheckingAction(Action):
    ...
    async def run(self, context: ActionContext) -> ActionResponse:
        ...
        current_intent = context.conversation.current_intent.name
        ...
        answer = ChatResponseAnswer(messageType=ResponseMessageType.FORMAT_TEXT, content=result, intent=current_intent)
