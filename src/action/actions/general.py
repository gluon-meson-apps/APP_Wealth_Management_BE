...
class SlotFillingAction(Action):
    ...
    def run(self, context):
        ...
        detail = ChatResponseAnswer(
            messageType=ResponseMessageType.FORMAT_TEXT, content=response
        )
        return GeneralResponse(
            code=200, message="success", answer=detail, jump_out_flag=False
        )
